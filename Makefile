...
$(NAME): $(OBJEXEC) $(OBJPARSE)
	make -C ./libft
	$(CC) $(CFLAGS) $(LIBS) $(OBJEXEC) $(OBJPARSE) -L/Users/$(USER)/goinfre/.brew/opt/readline/lib -iquote /Users/$(USER)/goinfre/.brew/opt/readline/include/ -lreadline -fsanitize=address -g -o $(NAME)
